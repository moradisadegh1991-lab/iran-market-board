...
export const CHART_ASSETS: { key: AssetKey; label: string; unit: 'toman' | 'usd' | 'point'; cg?: string }[] = [
  ...
  { key: 'nim', label: 'نیم سکه', unit: 'toman' },
  { key: 'rob', label: 'ربع سکه', unit: 'toman' },
  { key: 'silver', label: 'نقره ۹۹۹ (گرم)', unit: 'toman' },
  { key: 'ons', label: 'انس جهانی طلا', unit: 'usd', cg: 'pax-gold' },
  { key: 'silverOns', label: 'انس جهانی نقره', unit: 'usd' },
